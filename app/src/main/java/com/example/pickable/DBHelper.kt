...
class DBHelper(context: Context) :
    ...
    override fun onCreate(MyDB: SQLiteDatabase?) {
        MyDB!!.execSQL("create Table users(id TEXT primary key, password TEXT, nick TEXT, age INT, gender TEXT)")
    }
    ...
    fun insertData (id: String?, password: String?, nick: String?, age : Int?, gender : String?): Boolean {
